...
### This is set up to be shapefile-specific. I'm not sure this can be avoided, as often shapefiles are pretty specific..
    try:
        ...
        polyName = get_LRA_polyName(lilshape)
        ...
        #also replaces apostrophes which break the javascript
        ...
        WOFS_df = pd.DataFrame(data=wofs_area_percent2.data, index=wofs_area_percent2.time.values,columns=['open_water_percent'])
