# notebookapp_FC_poly_timeseries.py
'''
This file is a modification of notebookapp_miningrehab.py and contains functions 
for loading and interacting with Fractional Cover data via the VegAnalysis_FC notebook.
...
def load_FC_data():
    ...
    latitude = (-20.79, -20.86)
    longitude = (134.24, 134.34)

    # Specify the date range
    time = ('2015-01', '2018-12')
...
def run_FCanalysis_app(ds):
    ...
    geom_obj = {
        ...
        "geometry": {
            ...
            "coordinates": [
                [
                    [134.24, -20.86],         # Bottom left
                    [134.24, -20.79],         # Top left
                    [134.34, -20.79],         # Top Right
                    [134.34, -20.86],         # Bottom Right
                    [134.24, -20.86],         # Bottom Left
                ]
            ],
        },
    ...
    studyarea_map = Map(
        layout=widgets.Layout(width="10000px", height="10000px"),
    ...
    fig_display = widgets.Output(
        layout=widgets.Layout(
            width="10%"  # proportion of horizontal space taken by plot
        )
    )
