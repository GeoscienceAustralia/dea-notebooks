...
warnings.warn("Scripts/dea_* scripts have been deprecated in favour of the dea-tools module. Please import dea_tools.temporal instead.", DeprecationWarning)
...
from dea_tools.temporal import *