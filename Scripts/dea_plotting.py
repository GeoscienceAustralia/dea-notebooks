...
warnings.warn("Scripts/dea_* scripts have been deprecated in favour of the dea-tools module. Please import dea_tools.plotting instead.", DeprecationWarning)
...
from dea_tools.plotting import *