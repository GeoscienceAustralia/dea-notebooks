...
def imageSeg(InputNDVIStats,KEAFile,SegmentedKEAFile, SegmentedTiffFile, SegmentedPolygons, minPxls = 200, epsg = '3577'):
    #convert tiff to .kea using gdal
    print('converting tif to a kea file...')
    gdal.Translate(KEAFile, InputNDVIStats, format='KEA', outputSRS='EPSG:' + epsg)
    ...
    os.system("gdal_translate -of GTIFF -a_srs EPSG:" + epsg + " " + SegmentedKEAFile + " " + SegmentedTiffFile)
