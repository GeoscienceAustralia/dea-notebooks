...
class wit_app(HBox):
    ...
    def __init__(self):
        ...
        instruction_text = "Select parameters and draw a polygon on the map to extract a staked line plot for a given area. Alternatively, <b>upload a shapefile or a GeoJSON</b> to extract a stacked line plot for your wetland of interest polygon."
        ...
        grid[7:8, :] = self.progress_bar
        # grid[7:8, :] = self.dask_client

        # Plot
        grid[8:, :] = self.wit_plot
