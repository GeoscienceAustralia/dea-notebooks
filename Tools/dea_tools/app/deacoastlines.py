...
class transect_app(HBox):
    def __init__(self):
        ...
        text_output_name = create_inputtext(self.output_name, self.output_name)
        checkbox_csv = create_checkbox(self.export_csv, "Distance table (.csv)")
        checkbox_plot = create_checkbox(self.export_plot, "Figure (.png)")
        deaoverlay_dropdown = create_dropdown(self.product_list, self.product_list[0][1])
        mode_dropdown = create_dropdown(self.mode_list, self.mode_list[0][1])
        ...
        parameter_selection = VBox([
            ...
            text_output_name,
            HTML('<b>Transect extraction mode:</b><br><img src="https://i.imgur.com/9fdTH9C.png">'),
            mode_dropdown,
        ...
        with self.status_info:
            try:
                ...
                if "id" in transect_gdf:
                    ...
                    print(f"Uploaded '{valid_file}'; automatically labelling transects using column 'id'.")
                else:
                    print(
        ...
        with self.status_info:
            ...
            if transect_gdf is not None:
                ...
                if deacl_gdf is not None:
                    ...
                    dist_df = transect_distances(transect_gdf.to_crs("EPSG:3577"), deacl_gdf, mode=self.mode)
