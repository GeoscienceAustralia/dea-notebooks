...
<<<<<<< HEAD:Scripts/dea_bandindices.py
Last modified: September 2020
=======
Last modified: March 2021
>>>>>>> develop:Tools/dea_tools/bandindices.py
...
>>>>>>> develop:Tools/dea_tools/bandindices.py
    ...
    index_dict = {
                  ...
                  # Normalised Difference Aquatic Vegetation Index, Villa et al., 2013
                  'NDAVI': lambda ds: (ds.nir - ds.blue) /
                                      (ds.nir + ds.blue),

                  # Water Adjusted Vegetation Index, Villa et al., 2013
                  'WAVI': lambda ds: ((1.5 * (ds.nir - ds.blue)) /
                                        (ds.nir + ds.blue + 0.5)),
