...
1. Use Datacube Stats to create seasonal composites of maximum NDVI. 
...
5. Run 'SICA_parallel_nmdb.py'. This does the bulk of the analysis by pulling in the 
	...
	in the qsub submission script.
		...
		/g/data/r78/cb3058/dea-notebooks/ICE_project/SICA_parallel.py
		/g/data/r78/cb3058/dea-notebooks/ICE_project/run_SICA.sh

6. The results of step 5 produce files called e.g. '<AOI>_<Season+Year>_80polys10ha.shp'
	...
	very fast at this but QGIS and python libraries are prohibitively slow).
...
7. Using a good basemap, manually curate egregious commission errors contained in the 
    ...
    artefacts from geometric errors in the LS7 satellite data that need to be deleted.
...
9.	Using the 'inspect_resuts.ipynb' notebook, generate plots showing the time-series of annual irrigated area
    and cumulative new irrigable area.
	Plots can be created for the whole catchment, and/or for subcatchments if shapefiles of the subcatchments
	are available.
    
10. The scripts 'croppingFrequency.ipynb', 'dateFirstObserved.ipynb', 'correlation.ipynb', and 'uncertainty.ipynb'
    each process the SICA results to derive further insights.
