...
for i in $(seq 0 $(($NNODES-1))); do
    ...
    echo $i:\
    cd $JOBDIR;\
    parallel --delay 5 --retries 3 --load 100%  --colsep ',' python /g/data/r78/rjd547/jupyter_notebooks/dea-notebooks/00_Development_Notebooks/DES-QLD_Project/DES_WIT_QLD_v2P/DES_WIT_raijinP.py ::: $PARAMF"&
done;
wait;
